    ...
    Scaffold(
        ...
        bottomBar = {
            Column(
                ...
                Column(
                    ...
                    Description(
                        text = stringResource(id = R.string.signature_confirmation),
                    ...
                    LendlyButton(
                        text = stringResource(id = R.string.signature_next_button),
                        onClick = onNextClick,
        ...
        Column(
            ...
            Column(
                ...
                Title(text = stringResource(id = R.string.signature_title))

                Spacer(modifier = Modifier.height(12.dp))

                Description(text = stringResource(id = R.string.signature_subtitle))
