    ...
    Scaffold(
        ...
        bottomBar = {
            Column(
                ...
                Column(
                    ...
                    LendlyButton(
                        text = stringResource(id = R.string.face_recognition_next_button),
                        onClick = onNextClick,
        ...
        Column(
            ...
            Column(
                ...
                Title(text = stringResource(id = R.string.face_recognition_title))

                Spacer(modifier = Modifier.height(12.dp))

                Description(text = stringResource(id = R.string.face_recognition_subtitle))

                Spacer(modifier = Modifier.height(32.dp))
            }

            Image(
                painter = painterResource(id = R.drawable.login_face),
